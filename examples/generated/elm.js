...
var $author$project$DataTable$Pager = function (a) {
	return { $: 'Pager', a: a };
};
...
var $author$project$DataTable$initialState$ = function(id, paginationStyle) {
	var f = $gren_lang$core$Basics$composeL$($gren_lang$core$Basics$composeL$($gren_lang$core$Maybe$withDefault(0), $gren_lang$core$Maybe$map(function ($) {
					return $.first;
				})), $gren_lang$core$Array$popFirst);
	var initialPageSize = function () {
		switch (paginationStyle.$) {
			case 'NoPagination':
				return 0;
			case 'Pager':
				var pageSizes = paginationStyle.a;
				return f(pageSizes);
			default:
				var pageSizes = paginationStyle.a;
				return f(pageSizes);
	...
	switch (paginationStyle.$) {
		case 'NoPagination':
			return $author$project$DataTable$State({ pageSize: 0, pagination: $author$project$DataTable$NoPagination, rowCursor: 0, sortColumns: [  ], tableId: id });
		case 'Pager':
			var pageSizes = paginationStyle.a;
			return $author$project$DataTable$State({ pageSize: initialPageSize, pagination: $author$project$DataTable$Pager(pageSizes), rowCursor: 0, sortColumns: [  ], tableId: id });
		default:
			var pageSizes = paginationStyle.a;
			return $author$project$DataTable$State({ pageSize: initialPageSize, pagination: $author$project$DataTable$Scroller(pageSizes), rowCursor: 0, sortColumns: [  ], tableId: id });
	}
};
var $author$project$DataTable$initialState = F2($author$project$DataTable$initialState$);
...
var $author$project$DataTable$simplePagination = $author$project$DataTable$Pager([ 10, 25, 50, 100 ]);
...
var $author$project$DataTable$updateMultiSortState$ = function(newSortColumn, sortDirection, _v0) {
	...
	return $author$project$DataTable$State({ pageSize: pageSize, pagination: pagination, rowCursor: rowCursor, sortColumns: newSortState, tableId: tableId });
};
...
var $author$project$DataTable$updateSortState$ = function(newSortColumn, sortDirection, _v0) {
	...
	var pagination = _v1.pagination;
	var tableId = _v1.tableId;
	return $author$project$DataTable$State({ pageSize: pageSize, pagination: pagination, rowCursor: rowCursor, sortColumns: [ { sortColumnName: newSortColumn, sortDirection: sortDirection } ], tableId: tableId });
};
...
var $author$project$PresidentsPaginated$init = function(people) {
	var model = { people: people, query: '', tableState: $author$project$DataTable$updateMultiSortState$('Year', $author$project$DataTable$Asc, $author$project$DataTable$updateSortState$('State', $author$project$DataTable$Desc, $author$project$DataTable$initialState$('Presidents', $author$project$DataTable$simplePagination))) };
...
var $author$project$DataTable$getRowCursor = function(_v0) {
	var rowCursor = _v0.a.rowCursor;
	return rowCursor;
};
...
var $author$project$DataTable$updateRowCursor$ = function(newRowCursor, _v0) {
	var _v1 = _v0.a;
	var sortColumns = _v1.sortColumns;
	var pageSize = _v1.pageSize;
	var pagination = _v1.pagination;
	var tableId = _v1.tableId;
	return $author$project$DataTable$State({ pageSize: pageSize, pagination: pagination, rowCursor: newRowCursor, sortColumns: sortColumns, tableId: tableId });
};
var $author$project$DataTable$updateRowCursor = F2($author$project$DataTable$updateRowCursor$);
var $author$project$DataTable$simpleRowAttrs$ = function(toMsg, state, _v0) {
	var is_current_row = (0 === $author$project$DataTable$getRowCursor(state)) ? false : false;
	return is_current_row ? [ A2($gren_lang$browser$Html$Attributes$style, 'background', '#CEFAF8') ] : [ $gren_lang$browser$Html$Events$onClick(toMsg($author$project$DataTable$updateRowCursor$(0, state))) ];
};
var $author$project$DataTable$simpleRowAttrs = F3($author$project$DataTable$simpleRowAttrs$);
...
var $author$project$DataTable$updatePageSize$ = function(minimumNewPageSize, _v0) {
	...
	return $author$project$DataTable$State({ pageSize: newPageSize, pagination: pagination, rowCursor: rowCursor, sortColumns: sortColumns, tableId: tableId });
};
...
var $author$project$DataTable$pageLength$ = function(_v0, tableState) {
...
var $author$project$DataTable$pageLength = F2($author$project$DataTable$pageLength$);
...
var $author$project$DataTable$getPaginatedData$ = function(_v0, data) {
	var _v1 = _v0.a;
	var pageSize = _v1.pageSize;
	var rowCursor = _v1.rowCursor;
	var pagination = _v1.pagination;
		...
		switch (pagination.$) {
			...
			case 'Scroller':
				if (pageSize === 0) {
					...
					var _v6 = A2($gren_lang$core$Basics$compare, rowCursor, (pageSize / 2) | 0);
					if (_v6.$ === 'GT') {
	...
	var lastRowBeforePage = function () {
		switch (pagination.$) {
			...
			case 'Scroller':
				var _v3 = A2($gren_lang$core$Basics$compare, rowCursor, $gren_lang$core$Array$length(data) - ((pageSize / 2) | 0));
				if (_v3.$ === 'GT') {
	...
	return $gren_lang$core$Array$dropFirst$(lastRowBeforePage, $gren_lang$core$Array$takeFirst$(lastRowOnPage, data));
};
var $author$project$DataTable$getPaginatedData = F2($author$project$DataTable$getPaginatedData$);
...
var $author$project$DataTable$sort$ = function(_v0, cData, data) {
	...
	if (_v2.$ === 'Just') {
		...
		if (_v5.$ === 'Nothing') {
			...
			var sorter = _v5.a;
			return $author$project$DataTable$sort$($author$project$DataTable$State({ pageSize: pageSize, pagination: pagination, rowCursor: rowCursor, sortColumns: rest, tableId: tableId }), cData, $author$project$DataTable$applySorter$(sortDirection, sorter, data));
		}
	} else {
		return data;
	}
...
var $author$project$DataTable$viewRowHelp$ = function(columns, toRowAttrs, toMsg, state, data) {
	return A2($gren_lang$browser$Html$tr, A3(toRowAttrs, toMsg, state, data), A2($gren_lang$core$Array$map, $author$project$DataTable$viewCell(data), columns));
};
var $author$project$DataTable$viewRowHelp = F5($author$project$DataTable$viewRowHelp$);
var $author$project$DataTable$viewRow$ = function(toId, toMsg, columns, toRowAttrs, state, data) {
	return { key: toId(data), node: $author$project$DataTable$viewRowHelp$(columns, toRowAttrs, toMsg, state, data) };
};
var $author$project$DataTable$viewRow = F6($author$project$DataTable$viewRow$);
var $author$project$DataTable$paginatedView$ = function(conf, state, data) {
	var _v0 = conf.a;
	var toId = _v0.toId;
	var toMsg = _v0.toMsg;
	var columns = _v0.columns;
	var customizations = _v0.customizations;
	var rows = $author$project$DataTable$getPaginatedData$(state, $author$project$DataTable$getSortedData$(conf, state, data));
...
var $author$project$DataTable$paginatedView = F3($author$project$DataTable$paginatedView$);
...
var $author$project$PresidentsPaginated$view = function(_v0) {
	...
	return A2($gren_lang$browser$Html$div, [  ], [ A2($gren_lang$browser$Html$h1, [  ], [ $gren_lang$browser$Html$text('Birthplaces of U.S. Presidents') ]), A2($gren_lang$browser$Html$ul, [  ], [ A2($gren_lang$browser$Html$li, [  ], [ $gren_lang$browser$Html$text('Single click on column header to add/move that column to the end of the sort order (...then sort by Year)') ]), A2($gren_lang$browser$Html$li, [  ], [ $gren_lang$browser$Html$text('Double click to reset the sort order to just that column (Sort by Name).') ]), A2($gren_lang$browser$Html$li, [  ], [ $gren_lang$browser$Html$text('I don\'t like this user interaction, but it is, what it is for now. Suggestions for change welcome.') ]), A2($gren_lang$browser$Html$li, [  ], [ $gren_lang$browser$Html$text('I\'d prefer to make short click reset and long click add to sort order.') ]) ]), A2($gren_lang$browser$Html$div, [  ], [  ]), A2($gren_lang$browser$Html$input, [ $gren_lang$browser$Html$Attributes$placeholder('Search by Name'), $gren_lang$browser$Html$Events$onInput($author$project$PresidentsPaginated$SetQuery) ], [  ]), $author$project$DataTable$pageLength$($author$project$PresidentsPaginated$config, tableState), $author$project$DataTable$paginatedView$($author$project$PresidentsPaginated$config, tableState, acceptablePeople) ]);
};
...
var $author$project$DataTable$initialSort = function(header) {
	return $author$project$DataTable$State({ pageSize: 0, pagination: $author$project$DataTable$NoPagination, rowCursor: 0, sortColumns: [ { sortColumnName: header, sortDirection: $author$project$DataTable$Asc } ], tableId: 'sortableTable' });
};
...
var $author$project$DataTable$view$ = function(conf, _v0, data) {
	var _v1 = _v0.a;
	var sortColumns = _v1.sortColumns;
	var rowCursor = _v1.rowCursor;
	var tableId = _v1.tableId;
	return $author$project$DataTable$paginatedView$(conf, $author$project$DataTable$State({ pageSize: 0, pagination: $author$project$DataTable$NoPagination, rowCursor: rowCursor, sortColumns: sortColumns, tableId: tableId }), data);
};
...
//# sourceMappingURL=data:application/json;base64,