...
var $author$project$PresidentsPaginated$init = function(people) {
	var model = { people: people, query: '', tableState: $author$project$DataTable$updateRowCursor$(5, $author$project$DataTable$updateMultiSortState$('Year', $author$project$DataTable$Asc, $author$project$DataTable$setScrollingPaginationWith$(10, [ 0, 5, 25, 50 ], $author$project$DataTable$new('Presidents')))) };
...
var $author$project$PresidentsPaginated$view = function(_v0) {
	...
	return A2($gren_lang$browser$Html$div, [  ], [ A2($gren_lang$browser$Html$h1, [  ], [ $gren_lang$browser$Html$text('Birthplaces of U.S. Presidents') ]), A2($gren_lang$browser$Html$ul, [  ], [ A2($gren_lang$browser$Html$li, [  ], [ $gren_lang$browser$Html$text('Single click on column header to add/move that column to the end of the sort order (...then sort by Year)') ]), A2($gren_lang$browser$Html$li, [  ], [ $gren_lang$browser$Html$text('Double click to reset the sort order to just that column (Sort by Name).') ]), A2($gren_lang$browser$Html$li, [  ], [ $gren_lang$browser$Html$text('I don\'t like this user interaction, but it is, what it is for now. Suggestions for change welcome.') ]), A2($gren_lang$browser$Html$li, [  ], [ $gren_lang$browser$Html$text('I\'d prefer to make short click reset and long click add to sort order.') ]) ]), A2($gren_lang$browser$Html$div, [  ], [  ]), A2($gren_lang$browser$Html$input, [ $gren_lang$browser$Html$Attributes$placeholder('Search by Name'), $gren_lang$browser$Html$Events$onInput($author$project$PresidentsPaginated$SetQuery) ], [  ]), $author$project$DataTable$pageLength$($author$project$PresidentsPaginated$config, tableState), $author$project$DataTable$view$($author$project$PresidentsPaginated$config, tableState, acceptablePeople) ]);
};
