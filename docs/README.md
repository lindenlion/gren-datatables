...
run `gren make --output=app.js --sourcemaps --optimize src/*.gren src/Example/*.gren` in the /docs folder to regenerate the app.js file after modifying or adding a file in the `src` folder.
